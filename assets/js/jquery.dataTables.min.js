...
;(function (Ea, P, k) {
  var O = function (h) {
    function V (a) {
      ...
      h.each(a, function (d) {
        if (
          ...
          (c = d.replace(b[0], b[2].toLowerCase())), (e[c] = d), b[1] === 'o' &&
            V(a[d])
        }
      })
      a._hungarianMap = e
    ...
    function O (a) {
      ...
      !a.sEmptyTable &&
        (c && b.sEmptyTable === 'No data available in table') &&
        E(a, a, 'sZeroRecords', 'sEmptyTable')
      !a.sLoadingRecords &&
        (c && b.sLoadingRecords === 'Loading...') &&
    ...
    function gb (a) {
      var a = a.oBrowser,
        b = h('<div/>')
          ...
          .appendTo('body'),
        c = b.find('.test')
      a.bScrollOversize = c[0].offsetWidth === 100
    ...
    function ka (a, b, c) {
      ...
      c !== k &&
        c !== null &&
        (fb(c), H(m.defaults.column, c), c.mDataProp !== k &&
          !c.mData &&
          (c.mData = c.mDataProp), c.sType &&
          (b._sManualType = c.sType), c.className &&
          !c.sClass &&
          (c.sClass = c.className), h.extend(b, c), E(
          b,
          c,
          'sWidth',
          'sWidthOrig'
        ), c.iDataSort !== k && (b.aDataSort = [c.iDataSort]), E(
          b,
          c,
          'aDataSort'
        ))
      ...
      !b.bSortable || (!a && !c)
        ...
        : a && !c
            ? ((b.sSortingClass = e.sSortableAsc), (b.sSortingClassJUI =
                e.sSortJUIAscAllowed))
            : !a && c
                ? ((b.sSortingClass = e.sSortableDesc), (b.sSortingClassJUI =
                    e.sSortJUIDescAllowed))
                : ((b.sSortingClass = e.sSortable), (b.sSortingClassJUI =
                    e.sSortJUI))
    }
    function X (a) {
    ...
    function Ha (a) {
      ...
      for (f = b.length; d < f; d++) {
        if (((l = b[d]), (o = []), !l.sType && l._sManualType)) { l.sType = l._sManualType } else if (!l.sType) {
          g = 0
        ...
        for (d = b.length - 1; d >= 0; d--) {
          ...
          for (g = q.length; f < g; f++) {
            if (typeof q[f] === 'number' && q[f] >= 0) {
              ...
              e(q[f], n)
            } else if (typeof q[f] === 'number' && q[f] < 0) { e(l.length + q[f], n) } else if (typeof q[f] === 'string') {
              i = 0
              for (j = l.length; i < j; i++) { (q[f] == '_all' || h(l[i].nTh).hasClass(q[f])) && e(i, n) }
            }
          }
        }
      }
    ...
    function y (a, b, c, e) {
      ...
      if ((c === g || c === null) && i !== null) c = i
      else if (typeof c === 'function') return c.call(g)
      return c === null && e == 'display' ? '' : c
    }
    function Ia (a, b, c, e) {
    ...
    function ca (a, b, c, e) {
      ...
      if (c === 'dom' || ((!c || c === 'auto') && d.src === 'dom')) { d._aData = na(a, d, e, e === k ? k : d._aData).data } else {
        var i = d.anCells
        if (i) {
          if (e !== k) g(i[e], e)
          else {
    ...
    function na (a, b, c, e) {
      var d = [],
        ...
        q = function (a, b) {
          if (typeof a === 'string') {
            var c = a.indexOf('@')
            ;c !== -1 && ((c = a.substring(c + 1)), Q(a)(e, b.getAttribute(c)))
          }
        },
        a = function (a) {
          if (c === k || c === i) {
            (g = n[i]), (j = h.trim(a.innerHTML)), g && g._bAttrSrc
              ? (Q(g.mData._)(e, j), q(g.mData.sort, a), q(g.mData.type, a), q(
                  g.mData.filter,
                  a
                ))
              : l
    ...
    function jb (a) {
      var b,
        ...
        g = a.nTHead,
        i = a.nTFoot,
        j = h('th, td', g).length === 0,
        n = a.oClasses,
        l = a.aoColumns
      j && (d = h('<tr/>').appendTo(g))
      b = 0
      for (c = l.length; b < c; b++) {
        (f = l[b]), (e = h(f.nTh).addClass(f.sClass)), j && e.appendTo(d), a
          .oFeatures.bSort &&
          (e.addClass(f.sSortingClass), !1 !== f.bSortable &&
            (e
              .attr('tabindex', a.iTabIndex)
              .attr('aria-controls', a.sTableId), Oa(a, f.nTh, b))), f.sTitle !=
          e.html() && e.html(f.sTitle), Pa(a, 'header')(a, e, f, n)
      }
      j && da(a.aoHeader, g)
    ...
    function ea (a, b, c) {
      ...
      if (b) {
        ...
        for (d = b.length; e < d; e++) {
          g[e] = b[e].slice()
          g[e].nTr = b[e].nTr
          for (f = j - 1; f >= 0; f--) { !a.aoColumns[f].bVisible && !c && g[e].splice(f, 1) }
          i.push([])
        }
        e = 0
    ...
    function M (a) {
      ...
      if (h.inArray(!1, b) !== -1) C(a, !1)
        ...
        g !== k &&
          ...
          ((a._iDisplayStart = i
            ? g
            : g >= a.fnRecordsDisplay() ? 0 : g), (a.iInitDisplayStart = -1))
        ...
        if (j.length !== 0) {
          ...
          (c = f.sZeroRecords), a.iDraw == 1 && B(a) == 'ajax'
            ? (c = f.sLoadingRecords)
            : f.sEmptyTable &&
                a.fnRecordsTotal() === 0 &&
    ...
    function mb (a) {
      ...
      for (
        ...
        else if (i == 'l' && e.bPaginate && e.bLengthChange) g = nb(a)
        else if (i == 'f' && e.bFilter) g = ob(a)
        else if (i == 'r' && e.bProcessing) g = pb(a)
        else if (i == 't') g = qb(a)
        else if (i == 'i' && e.bInfo) g = rb(a)
        else if (i == 'p' && e.bPaginate) g = sb(a)
        else if (m.ext.feature.length !== 0) {
          j = m.ext.feature
          q = 0
    ...
    function qa (a, b, c) {
      ...
      for (var b = 0, d = c.length; b < d; b++) {
        for (var f = 0, g = c[b].length; f < g; f++) { if (c[b][f].unique && (!e[f] || !a.bSortCellsTop)) e[f] = c[b][f].cell }
      }
      return e
    }
    function ra (a, b, c) {
      ...
      n = {
        ...
        error: function (b, c) {
          ...
          c == 'parsererror'
            ...
            : b.readyState === 4 && f(a, 0, 'Ajax error', 7)
          C(a, !1)
        }
      }
      a.oAjaxData = b
    ...
    function tb (a) {
      ...
      for (g = 0; g < c; g++) {
        (n = b[g]), (l = f[g]), (j = typeof n.mData === 'function'
          ? 'function'
          : n.mData), k.columns.push({
            data: j,
            name: n.sName,
            searchable: n.bSearchable,
            orderable: n.bSortable,
            search: { value: l.sSearch, regex: l.bRegex }
          }), o('mDataProp_' + g, j), e.bFilter &&
          (o('sSearch_' + g, l.sSearch), o('bRegex_' + g, l.bRegex), o(
            'bSearchable_' + g,
            n.bSearchable
      ...
      b = m.ext.legacy.ajax
      return b === null ? a.sAjaxSource ? i : k : b ? i : k
    }
    function ub (a, b) {
      var c = sa(a, b),
    ...
    function sa (a, b) {
      var c = h.isPlainObject(a.ajax) && a.ajax.dataSrc !== k
        ? a.ajax.dataSrc
        : a.sAjaxDataProp
      return c === 'data' ? b.aaData || b[c] : c !== '' ? W(c)(b) : b
    }
    function ob (a) {
      var b = a.oClasses,
        c = a.sTableId,
        ...
        g = a.searchDelay !== null ? a.searchDelay : B(a) === 'ssp' ? 400 : 0,
        j = h('input', b)
          .val(d.sSearch)
    ...
    function vb (a, b, c, e, d, f) {
      var e = Qa(b, e, d, f),
        ...
        f = a.aiDisplayMaster,
        g
      m.ext.search.length !== 0 && (c = !0)
      g = yb(a)
      if (b.length <= 0) a.aiDisplay = f.slice()
      else {
        if (g || c || d.length > b.length || b.indexOf(d) !== 0 || a.bSorted) { a.aiDisplay = f.slice() }
        b = a.aiDisplay
        for (c = b.length - 1; c >= 0; c--) { e.test(a.aoData[b[c]]._sFilterRow) || b.splice(c, 1) }
      }
    }
    function Qa (a, b, c, e) {
      a = b ? a : va(a)
      ...
      for (f = a.aoData.length; e < f; e++) {
        if (((h = a.aoData[e]), !h._aFilterData)) {
          ...
          for (g = b.length; d < g; d++) {
            (c = b[d]), c.bSearchable
              ? ((j = y(a, e, d, 'filter')), l[c.sType] &&
                  (j = l[c.sType](j)), j === null && (j = ''), typeof j !==
                  'string' &&
                  j.toString &&
                  (j = j.toString()))
              : (j = ''), j.indexOf &&
    ...
    function rb (a) {
      ...
      c ||
        (a.aoDrawCallback.push({ fn: Bb, sName: 'information' }), e
          .attr('role', 'status')
    ...
    function Bb (a) {
      ...
      if (b.length !== 0) {
        ...
        i = Cb(a, i)
        c = c.fnInfoCallback
        c !== null && (i = c.call(a.oInstance, a, e, d, f, g, i))
        h(b).html(i)
      }
    }
    function Cb (a, b) {
    ...
    function nb (a) {
      ...
      j
        .children()
        .append(a.oLanguage.sLengthMenu.replace('_MENU_', d[0].outerHTML))
    ...
    function qb (a) {
      ...
      var e = c.sX,
        ...
        n = h(b[0].cloneNode(!1)),
        l = b.children('tfoot')
      c.sX && b.attr('width') === '100%' && b.removeAttr('width')
      l.length || (l = null)
    ...
    function Y (a) {
        ...
        if (
          ((u.width = '100%'), w &&
            (r.find('tbody').height() > j.offsetHeight ||
              q.css('overflow-y') == 'scroll'))
        ) { u.width = s(r.outerWidth() - f) }
      } else {
        e !== ''
          ? (u.width = s(e))
          : g == q.width() && q.height() < r.height()
              ? ((u.width = s(g - f)), r.outerWidth() > g - f &&
                  (u.width = s(g)))
              : (u.width = s(g))
      }
      g = r.outerWidth()
      ...
      if (r.outerWidth() < g) {
        v = j.scrollHeight > j.offsetHeight || q.css('overflow-y') == 'scroll'
          ? g + f
          : g
        if (
          w &&
          (j.scrollHeight > j.offsetHeight || q.css('overflow-y') == 'scroll')
        ) {
          u.width = s(v - f)
      ...
      d &&
        b.bCollapse &&
        ((o.height = s(d)), (b = c && t.offsetWidth > j.offsetWidth
          ? f
          : 0), t.offsetHeight < j.offsetHeight &&
          (o.height = s(t.offsetHeight + b)))
      b = r.outerWidth()
      l[0].style.width = s(b)
      n.width = s(b)
      l = r.height() > j.clientHeight || q.css('overflow-y') == 'scroll'
      ha = 'padding' + (ha.bScrollbarLeft ? 'Left' : 'Right')
      n[ha] = l ? f + 'px' : '0px'
      K &&
        ((p[0].style.width = s(b)), (k[0].style.width = s(b)), (k[0].style[
          ha
        ] = l ? f + 'px' : '0px'))
      q.scroll()
    ...
    function G (a, b, c) {
      for (var e = 0, d = 0, f = b.length, g, i; d < f;) {
        ...
        for (i = c ? c[d].firstChild : null; g;) {
          g.nodeType === 1 && (c ? a(g, i, e) : a(g, e), e++), (g =
    ...
    function Ga (a) {
      var b = a.nTable,
        ...
        o,
        m
        ;(o = b.style.width) && o.indexOf('%') !== -1 && (n = o)
      for (o = 0; o < e.length; o++) {
        (m = c[e[o]]), m.sWidth !== null &&
      ...
      if (!k && !f && !d && i == aa(a) && i == j.length) {
        ...
        for (o = 0; o < e.length; o++) {
          (m = c[e[o]]), (j[o].style.width = m.sWidthOrig !== null &&
            m.sWidthOrig !== ''
            ? s(m.sWidthOrig)
            : '')
        }
        ...
        f && g
          ? i.width(g)
          : f
              ? (i.css('width', 'auto'), i.width() < l.offsetWidth &&
                  i.width(l.offsetWidth))
              : d ? i.width(l.offsetWidth) : n && i.width(n)
        Fb(a, i[0])
        if (f) {
          for (o = g = 0; o < e.length; o++) {
            (m = c[e[o]]), (d = h(j[o]).outerWidth()), (g += m.sWidthOrig ===
              null
              ? d
        ...
        for (o = 0; o < e.length; o++) { if (((m = c[e[o]]), (d = h(j[o]).width()))) m.sWidth = s(d) }
    ...
    function Fb (a, b) {
      var c = a.oScroll
      if (c.sX || c.sY) {
        (c = !c.sX ? c.iBarWidth : 0), (b.style.width = s(
          h(b).outerWidth() - c
        ))
      }
    }
    ...
    function Gb (a, b) {
      for (var c, e = -1, d = -1, f = 0, g = a.aoData.length; f < g; f++) {
        (c = y(a, f, b, 'display') + ''), (c = c.replace($b, '')), c.length >
          e && ((e = c.length), (d = f))
      }
      return d
    }
    ...
    function T (a) {
      ...
      for (a = 0; a < n.length; a++) {
        ...
        for (c = f.length; b < c; b++) {
          (g = f[b]), (i = d[g].sType || 'string'), n[a]._idx === k &&
            (n[a]._idx = h.inArray(n[a][1], d[g].asSorting)), e.push({
              src: j,
              col: g,
              dir: n[a][1],
              index: n[a]._idx,
        ...
        g === n.length
          ? h.sort(function (a, b) {
            ...
            for (
                ...
                g < i;
                g++
              ) if (((h = n[g]), (c = j[h.col]), (d = k[h.col]), (c = c < d ? -1 : c > d ? 1 : 0), c !== 0)) return h.dir === 'asc' ? c : -c
            c = e[a]
            d = e[b]
          ...
          : h.sort(function (a, b) {
            ...
            for (
                ...
                h < j;
                h++
              ) if (((i = n[h]), (c = k[i.col]), (g = m[i.col]), (i = d[i.type + '-' + i.dir] || d['string-' + i.dir]), (c = i(c, g)), c !== 0)) return c
            c = e[a]
            g = e[b]
    ...
    function Jb (a) {
      for (
        ...
        c.bSortable &&
          (d.length > 0 && d[0].col == f
            ? (h.setAttribute(
                'aria-sort',
                d[0].dir == 'asc' ? 'ascending' : 'descending'
              ), (c = i[d[0].index + 1] || i[0]))
            : (c = i[0]), (b += c === 'asc'
            ? a.sSortAscending
            : a.sSortDescending))
    ...
    function Ua (a, b, c, e) {
      ...
      typeof d[0] === 'number' && (d = a.aaSorting = [d])
      c && a.oFeatures.bSortMulti
        ? ((c = h.inArray(b, D(d, '0'))), c !== -1
            ? ((b = g(d[c], !0)), b === null &&
                d.length === 1 &&
                (b = 0), b === null
                ? d.splice(c, 1)
    ...
    function xa (a) {
      ...
      if (d.bSort && d.bSortClasses) {
        d = 0
        for (f = b.length; d < f; d++) {
          (g = b[d].src), h(D(a.aoData, 'anCells', g)).removeClass(
            c + (d < 2 ? d + 1 : 3)
          )
        }
        d = 0
        for (f = e.length; d < f; d++) {
          (g = e[d].src), h(D(a.aoData, 'anCells', g)).addClass(
            c + (d < 2 ? d + 1 : 3)
          )
        }
      }
    ...
    function Ib (a, b) {
      ...
      for (
        ...
        if (
          ((c = a.aoData[h]), c._aSortData || (c._aSortData = []), !c
            ._aSortData[b] || e)
    ...
    function Kb (a) {
      ...
      if (a.oFeatures.bStateSave) {
        ...
        if (
          d &&
          d.time &&
          ((b = w(a, 'aoStateLoadParams', 'stateLoadParams', [a, d])), h.inArray(!1, b) ===
            -1 &&
            ((b = a.iStateDuration), !(b > 0 &&
              d.time < +new Date() - 1e3 * b) && e.length === d.columns.length))
        ) {
          ...
          d.order !== k &&
            ((a.aaSorting = []), h.each(d.order, function (b, c) {
    ...
    function R (a, b, c, e) {
      ...
      if (b) Ea.console && console.log && console.log(c)
        ...
        ((b = m.ext), (b = b.sErrMode || b.errMode), w(a, null, 'error', [
          a,
          e,
          c
        ]), b == 'alert')
    ...
    function Lb (a, b, c) {
      ...
      for (d in b) {
        b.hasOwnProperty(d) &&
          ((e = b[d]), h.isPlainObject(e)
            ? (h.isPlainObject(a[d]) || (a[d] = {}), h.extend(!0, a[d], e))
            : (a[d] = c && d !== 'data' && d !== 'aaData' && h.isArray(e)
                ? e.slice()
                : e))
      }
      return a
    ...
    function w (a, b, c, e) {
      ...
      c !== null && h(a.nTable).trigger(c + '.dt', e)
      return d
    }
    function Sa (a) {
    ...
    function Wa (a, b) {
      ...
      b <= c
        ...
        : a <= e
            ...
            : (a >= b - 1 - e
                ? (c = U(b - (c - 2), b))
                : ((c = U(a - e + 2, a + e - 1)), c.push('ellipsis'), c.push(
                    b - 1
    ...
    m = function (a) {
      ...
      this.fnAddData = function (a, b) {
        var c = this.api(!0),
          e = h.isArray(a) && (h.isArray(a[0]) || h.isPlainObject(a[0]))
            ? c.rows.add(a)
            : c.row.add(a)
        ;(b === k || b) && c.draw()
      ...
      this.each(function () {
        var d = {},
          ...
          l = m.defaults,
          q = h(this)
        if (this.nodeName.toLowerCase() != 'table') { R(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2) } else {
          eb(l)
          fb(l.column)
          H(l, l, !0)
          ...
          if (j === null || j === '') { this.id = j = 'DataTables_Table_' + m.ext._unique++ }
          ...
          j = p.oClasses
          d.bJQueryUI
            ? (h.extend(j, m.ext.oJUIClasses, d.oClasses), d.sDom === l.sDom &&
                l.sDom === 'lfrtip' &&
                (p.sDom = '<"H"lfr>t<"F"ip>'), p.renderer)
          ...
          p.iInitDisplayStart === k &&
            ((p.iInitDisplayStart = d.iDisplayStart), (p._iDisplayStart =
              d.iDisplayStart))
          d.iDeferLoading !== null &&
            ((p.bDeferLoading = !0), (g = h.isArray(
              d.iDeferLoading
            )), (p._iRecordsDisplay = g
              ? d.iDeferLoading[0]
              : d.iDeferLoading), (p._iRecordsTotal = g
              ? d.iDeferLoading[1]
              : d.iDeferLoading))
          var t = p.oLanguage
          ...
          ;h.inArray(
            ...
            -1 &&
            (h('tbody tr', this).removeClass(
              g.join(' ')
            ), (p.asDestroyStripes = g.slice()))
          o = []
          g = this.getElementsByTagName('thead')
          g.length !== 0 && (da(p.aoHeader, g[0]), (o = qa(p)))
          if (d.aoColumns === null) {
            r = []
            g = 0
          ...
          i = q.children('thead')
          i.length === 0 && (i = h('<thead/>').appendTo(this))
          p.nTHead = i[0]
          i = q.children('tbody')
          i.length === 0 && (i = h('<tbody/>').appendTo(this))
          p.nTBody = i[0]
          i = q.children('tfoot')
          if (
            i.length === 0 &&
          ...
          i.length === 0 || i.children().length === 0
            ? q.addClass(j.sNoFooter)
            : i.length > 0 && ((p.nTFoot = i[0]), da(p.aoFooter, p.nTFoot))
          if (d.aaData) for (g = 0; g < d.aaData.length; g++) J(p, d.aaData[g])
          else {
            (p.bDeferLoading || B(p) == 'dom') &&
    ...
    var Tb = [],
      ...
      cc = function (a) {
        ...
        if (a) {
          ...
          if (a.nodeName && a.nodeName.toLowerCase() === 'table') { return (b = h.inArray(a, d)), b !== -1 ? [e[b]] : null }
    ...
    t.prototype = {
      ...
      iterator: function (a, b, c, e) {
        ...
        typeof a === 'string' && ((e = c), (c = b), (b = a), (a = !1))
        g = 0
        for (h = l.length; g < h; g++) {
          var p = new t(l[g])
          if (b === 'table') (f = c.call(p, l[g], g)), f !== k && d.push(f)
          else if (b === 'columns' || b === 'rows') { (f = c.call(p, l[g], this[g], g)), f !== k && d.push(f) } else if (
            b === 'column' ||
            b === 'column-rows' ||
            b === 'row' ||
            b === 'cell'
            ...
            o = this[g]
            b === 'column-rows' && (q = Ca(l[g], m.opts))
            j = 0
            for (n = o.length; j < n; j++) {
              (f = o[j]), (f = b === 'cell'
                ? c.call(p, l[g], f.row, f.column, g, j)
                : c.call(p, l[g], f, g, j, q)), f !== k && d.push(f)
            }
          }
        }
        return d.length || e
          ? ((a = new t(l, a ? d.concat.apply([], d) : d)), (b =
              a.selector), (b.rows = m.rows), (b.cols = m.cols), (b.opts =
              m.opts), a)
          : this
      },
    ...
    t.extend = function (a, b, c) {
      if (c.length && b && (b instanceof t || b.__dt_wrapper)) {
        ...
        for (d = c.length; e < d; e++) {
          (f = c[e]), (b[f.name] = typeof f.val === 'function'
            ? g(a, f.val, f)
            : h.isPlainObject(f.val) ? {} : f.val), (b[
            f.name
          ].__dt_wrapper = !0), t.extend(a, b[f.name], f.propExt)
        }
      }
    }
    t.register = r = function (a, b) {
      if (h.isArray(a)) {
        ...
        for (
          ...
          g = (i = d[c].indexOf('()') !== -1) ? d[c].replace('()', '') : d[c]
          var j
          a: {
            j = 0
    ...
    t.registerPlural = u = function (a, b, c) {
      ...
      t.register(b, function () {
        ...
        return a === this
          ? this
          : a instanceof t
              ? a.length ? h.isArray(a[0]) ? new t(a.context, a[0]) : a[0] : k
              : a
      })
    }
    r('tables()', function (a) {
    ...
    var $a = function (a, b) {
        var c = [], e, d, f, g, i, j
        e = typeof a
        if (!a || e === 'string' || e === 'function' || a.length === k) a = [a]
        f = 0
        for (g = a.length; f < g; f++) {
          d = a[f] && a[f].split ? a[f].split(',') : [a[f]]
          i = 0
          for (j = d.length; i < j; i++) {
            (e = b(typeof d[i] === 'string' ? h.trim(d[i]) : d[i])) &&
            e.length &&
            c.push.apply(c, e)
          }
        }
      ...
      Ca = function (a, b) {
        ...
        e = b.order
        d = b.page
        if (B(a) == 'ssp') return i === 'removed' ? [] : U(0, c.length)
        if (d == 'current') {
          c = a._iDisplayStart
          for (e = a.fnDisplayEnd(); c < e; c++) { f.push(g[c]) }
        } else if (e == 'current' || e == 'applied') {
          f = i == 'none'
            ? c.slice()
            : i == 'applied'
                ? g.slice()
                : h.map(c, function (a) {
                  return h.inArray(a, g) === -1 ? a : null
                })
        } else if (e == 'index' || e == 'original') {
          c = 0
          for (e = a.aoData.length; c < e; c++) {
            i == 'none'
              ? f.push(c)
              : ((d = h.inArray(c, g)), ((d === -1 && i == 'removed') ||
                  (d >= 0 && i == 'applied')) &&
                  f.push(c))
          }
        }
    ...
    u('rows().cache()', 'row().cache()', function (a) {
      return this.iterator(
        ...
        function (b, c) {
          var e = b.aoData[c]
          return a === 'search' ? e._aFilterData : e._aSortData
        },
        1
      )
    })
    ...
    u('rows().remove()', 'row().remove()', function () {
      ...
      return this.iterator('row', function (b, c, e) {
        ...
        for (
          ...
          f < g;
          f++
        ) d[f].nTr !== null && (d[f].nTr._DT_RowIndex = f)
    ...
    r('rows.add()', function (a) {
      var b = this.iterator(
        ...
        function (b) {
          ...
          f = 0
          for (g = a.length; f < g; f++) {
            (c = a[f]), c.nodeName && c.nodeName.toUpperCase() === 'TR'
              ? h.push(ma(b, c)[0])
              : h.push(J(b, c))
          }
          return h
          ...
          f = function (a, b) {
            if (h.isArray(a) || a instanceof h) {
              ...
              a.nodeName && a.nodeName.toLowerCase() === 'tr'
                ? d.push(a)
                : ((c = h('<tr><td/></tr>').addClass(b)), (h('td', c)
                    .addClass(b)
                    .html(a)[0].colSpan = aa(e)), d.push(c[0]))
            }
          }
        f(a, b)
        ...
        if (a !== k && f.bVisible !== a) {
          if (a) {
            ...
            for (j = g.length; i < j; i++) {
              (n = g[i].nTr), (d = g[i].anCells), n &&
                n.insertBefore(d[e], d[l] || null)
            }
    ...
    r('column.index()', function (a, b) {
      if (this.context.length !== 0) {
        ...
        if (a === 'fromVisible' || a === 'toData') return la(c, b)
        if (a === 'fromData' || a === 'toVisible') return $(c, b)
      }
    })
    ...
    r('search()', function (a, b, c, e) {
      var d = this.context
      return a === k
        ? d.length !== 0 ? d[0].oPreviousSearch.sSearch : k
    ...
    m.versionCheck = m.fnVersionCheck = function (a) {
      for (
        ...
        if (
          ((c = parseInt(b[d], 10) || 0), (e = parseInt(a[d], 10) || 0), c !==
            e)
        ) { return c > e }
      }
      return !0
      ...
      return this.iterator('table', function (b) {
        ...
        b.bJUI &&
          (h(
            ...
            g
          ).detach(), h('th, td', g).each(function () {
    ...
    h.extend(m.ext.type.search, {
      html: function (a) {
        return I(a)
          ? a
          : typeof a === 'string' ? a.replace(Ob, ' ').replace(Ba, '') : ''
      },
      string: function (a) {
            ...
            if (a === f) {
              ...
              b
                ...
                .addClass(
                  h[d] == 'asc'
                    ? e.sSortAsc
                    : h[d] == 'desc' ? e.sSortDesc : c.sSortingClass
                )
            }
          })
        },
            ...
            if (a === f) {
              ...
              b
                ...
                .addClass(
                  h[d] == 'asc'
                    ? e.sSortJUIAsc
                    : h[d] == 'desc' ? e.sSortJUIDesc : c.sSortingClassJUI
                )
            }
          })
        }
